  ...
  return (
    <>
      ...
      <Grass column={2} row={4}>
        ...
        >
          <img
            src="/assets/images/plant/carot1.png"
            style={{
              marginTop: "-15px",
            }}
          />
      ...
      <Grass column={2} row={5}>
        ...
        >
          <img
            src="/assets/images/plant/carotseeding.png"
            style={{
              marginTop: "-10px",
            }}
          />
      ...
      <Grass column={3} row={4}>
        ...
        >
          <img
            src="/assets/images/plant/carothavert.png"
            style={{
              marginTop: "-10px",
            }}
          />
      ...
      <Grass column={9} row={8}>
        ...
        >
          <img
            src="/assets/images/deco/bush-001.png"
            style={{
              marginTop: "-15px",
            }}
          />
